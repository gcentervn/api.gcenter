...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('games_os_systems/manage', 'View All Games Os Systems', array("class" => "button alt"));
        echo anchor('games_os_systems/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('games_os_systems/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete a Games OS System record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
